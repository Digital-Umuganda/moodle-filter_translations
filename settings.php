...
if ($ADMIN->fulltree) {
    $list_of_translations = get_string_manager()->get_list_of_translations(true);

    $settings->add(new admin_setting_heading(
        'managetranslations',
        '',
        html_writer::link(
            new moodle_url('/filter/translations/managetranslations.php'),
            get_string('managetranslations', 'filter_translations'),
            ['class' => "btn btn-primary"]
        )
    ));

    $settings->add(new admin_setting_heading(
        'managetranslationissues',
        '',
        html_writer::link(
            new moodle_url('/filter/translations/managetranslationissues.php'),
            get_string('managetranslationissues', 'filter_translations'),
            ['class' => "btn btn-primary"]
        )
    ));
    ...
    $settings->add(new admin_setting_configcheckbox(
        'filter_translations/showperfdata',
        get_string('showperfdata', 'filter_translations'),
        '',
        false
    ));
    ...
    $settings->add(new admin_setting_configselect(
        'filter_translations/cachingmode',
        get_string('cachingmode', 'filter_translations'),
        get_string('cachingmode_desc', 'filter_translations'),
    ...
    $settings->add(
        new admin_setting_configtextarea(
            'filter_translations/untranslatedpages',
    ...
    $settings->add(new admin_setting_configmultiselect(
        'filter_translations/logexcludelang',
    ...
    $settings->add(new admin_setting_configcheckbox(
        'filter_translations/logmissing',
        get_string('logmissing', 'filter_translations'),
        '',
        false
    ));

    $settings->add(new admin_setting_configcheckbox(
        'filter_translations/logstale',
        get_string('logstale', 'filter_translations'),
        '',
        false
    ));

    $settings->add(new admin_setting_configduration(
        'filter_translations/logdebounce',
        get_string('logdebounce', 'filter_translations'),
        '',
        DAYSECS
    ));
    ...
    $settings->add(new admin_setting_configcheckbox(
        ...
        get_string('languagestringreverse_enable', 'filter_translations'),
        '',
        false
    ));
    ...
    $settings->add(new admin_setting_configcheckbox(
        'filter_translations/google_enable',
        get_string('google_enable', 'filter_translations'),
        '',
        false
    ));

    $settings->add(new admin_setting_configcheckbox(
        'filter_translations/google_backoffonerror',
        get_string('google_backoffonerror', 'filter_translations'),
        '',
        false
    ));

    $settings->add(new admin_setting_configtext(
        'filter_translations/google_apiendpoint',
    ...
    $settings->add(new admin_setting_configtext(
        'filter_translations/google_apikey',
        get_string('google_apikey', 'filter_translations'),
        '',
        null,
        PARAM_RAW_TRIMMED,
        40
